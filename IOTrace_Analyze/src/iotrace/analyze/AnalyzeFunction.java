...
public class AnalyzeFunction {
	...
	public AnalyzeFunction(String function, HashMap<String, String> classNames,
			HashMap<String, AnalyzeFunction> functions) throws ClassNotFoundException, NoSuchMethodException,
	...
	private void parseParameters(String stringParameters, HashMap<String, String> classNames,
			HashMap<String, AnalyzeFunction> functions) throws ClassNotFoundException, NoSuchMethodException,
			SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
	...
	private void parseEnum(String stringEnum, HashMap<String, String> classNames)
	...
	public Object invoke(HashMap<String, Object> objects, HashMap<String, AnalyzeFunction> functions)
		...
		if (className != null) {
			...
			for (int i = 0; i < parameters.size(); i++) {
				Object parm = parameters.get(i);
				if (parm instanceof AnalyzeFunction) {
					params[i] = ((AnalyzeFunction) parm).invoke(objects, functions);
				} else {
					params[i] = parm;
				}
			}
