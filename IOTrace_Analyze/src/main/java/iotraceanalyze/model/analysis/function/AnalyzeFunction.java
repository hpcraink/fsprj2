...
public class AnalyzeFunction {
	...
	public AnalyzeFunction(
				String function, Map<String, String> classNames,
				Map<String, AnalyzeFunction> functions)
	...
	public Object invoke(Map<String, Object> objects, Map<String, AnalyzeFunction> functions)
			throws ReflectiveOperationException,
	...
	private void parseParameters(
			String stringParameters, Map<String, String> classNames,
			Map<String, AnalyzeFunction> functions) throws ReflectiveOperationException,
			SecurityException, IllegalArgumentException {
	...
	private void parseEnum(String stringEnum, Map<String, String> classNames) throws ReflectiveOperationException,
			SecurityException, IllegalArgumentException {
