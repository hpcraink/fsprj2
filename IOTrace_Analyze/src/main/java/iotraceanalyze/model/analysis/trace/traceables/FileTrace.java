...
import iotraceanalyze.model.analysis.file.FileId;
...
public class FileTrace implements Traceable, Comparable<FileTrace> {
	...
	public FileTrace(FileId fileId, String fileName, FileType fileType, String directoryDelimiter, ResourceBundle legends) {
		super();
		this.fileId = fileId;
