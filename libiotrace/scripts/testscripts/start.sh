...
sbatch -p dev_multiple -N ${test_nodes} --mem=${test_mem} -t ${test_time} libiotracetest.sh ${test_script} ${test_name} ${test_influx_dir} ${test_dir} ${test_openfoam_dir} ${test_processes_per_worker}
