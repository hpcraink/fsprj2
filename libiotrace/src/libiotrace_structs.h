...
#   ifndef POWER_MEASUREMENT_NUMBER_OF_MPI_PROCESSES
#       define POWER_MEASUREMENT_NUMBER_OF_MPI_PROCESSES 1
#   endif
#endif
...
LIBIOTRACE_STRUCT_ENUM_START(stat_file_type)
  LIBIOTRACE_STRUCT_ENUM_ELEMENT(regular_file)     //S_IFREG
  LIBIOTRACE_STRUCT_ENUM_ELEMENT(directory)        //S_IFDIR
  LIBIOTRACE_STRUCT_ENUM_ELEMENT(character_device) //S_IFCHR
  LIBIOTRACE_STRUCT_ENUM_ELEMENT(block_device)     //S_IFBLK
  LIBIOTRACE_STRUCT_ENUM_ELEMENT(named_pipe)       //S_IFIFO
  LIBIOTRACE_STRUCT_ENUM_ELEMENT(symbolic_link)    //S_IFLNK
  LIBIOTRACE_STRUCT_ENUM_ELEMENT(socket_file)      //S_IFSOCK
  LIBIOTRACE_STRUCT_ENUM_ELEMENT(unknown_stat_file_type)
LIBIOTRACE_STRUCT_ENUM_END

LIBIOTRACE_STRUCT_ARRAY_BITFIELD_START(fstatat_flags)
  LIBIOTRACE_STRUCT_ARRAY_BITFIELD_ELEMENT(at_empty_path)
  LIBIOTRACE_STRUCT_ARRAY_BITFIELD_ELEMENT(at_no_automount)
  LIBIOTRACE_STRUCT_ARRAY_BITFIELD_ELEMENT(at_symlink_nofollow)
LIBIOTRACE_STRUCT_ARRAY_BITFIELD_END

/* struct for stat */
LIBIOTRACE_STRUCT_START(stat_function)
  LIBIOTRACE_STRUCT_CSTRING_P_CONST(file_name, MAXFILENAME)
  LIBIOTRACE_STRUCT_STRUCT(file_id, id)
  LIBIOTRACE_STRUCT_ENUM(stat_file_type, type)
  LIBIOTRACE_STRUCT_OFF_T(size)
  LIBIOTRACE_STRUCT_OFF_T(blocksize)
  LIBIOTRACE_STRUCT_OFF_T(allocated_512B_blocks)
LIBIOTRACE_STRUCT_END
LIBIOTRACE_STRUCT_START(fstat_function)
  LIBIOTRACE_STRUCT_ENUM(stat_file_type, type)
  LIBIOTRACE_STRUCT_OFF_T(size)
  LIBIOTRACE_STRUCT_OFF_T(blocksize)
  LIBIOTRACE_STRUCT_OFF_T(allocated_512B_blocks)
LIBIOTRACE_STRUCT_END
LIBIOTRACE_STRUCT_START(fstatat_function)
  ...
  LIBIOTRACE_STRUCT_OFF_T(blocksize)
  LIBIOTRACE_STRUCT_OFF_T(allocated_512B_blocks)
  LIBIOTRACE_STRUCT_ARRAY_BITFIELD(fstatat_flags, flags)
LIBIOTRACE_STRUCT_END
...
LIBIOTRACE_STRUCT_START(basic)
  ...
  LIBIOTRACE_STRUCT_VOID_P_START(function_data)
	...
	LIBIOTRACE_STRUCT_VOID_P_ELEMENT(function_data, stat_function)
	LIBIOTRACE_STRUCT_VOID_P_ELEMENT(function_data, fstat_function)
	LIBIOTRACE_STRUCT_VOID_P_ELEMENT(function_data, fstatat_function)
