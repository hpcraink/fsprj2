...
char activate_posix_wrapper(char *line)
{
	...
	WRAPPER_ACTIVATE(line, open)
	WRAPPER_ACTIVATE(line, open64)
	WRAPPER_ACTIVATE(line, openat)
	WRAPPER_ACTIVATE(line, creat)
	WRAPPER_ACTIVATE(line, creat64)
	WRAPPER_ACTIVATE(line, close)
	WRAPPER_ACTIVATE(line, read)
	WRAPPER_ACTIVATE(line, pread)
	WRAPPER_ACTIVATE(line, pread64)
	WRAPPER_ACTIVATE(line, write)
	WRAPPER_ACTIVATE(line, pwrite)
	WRAPPER_ACTIVATE(line, pwrite64)
	WRAPPER_ACTIVATE(line, lseek)
	WRAPPER_ACTIVATE(line, lseek64)
	WRAPPER_ACTIVATE(line, readv)
	WRAPPER_ACTIVATE(line, writev)
	WRAPPER_ACTIVATE(line, preadv)
	WRAPPER_ACTIVATE(line, preadv64)
	WRAPPER_ACTIVATE(line, pwritev)
	WRAPPER_ACTIVATE(line, pwritev64)
	WRAPPER_ACTIVATE(line, preadv2)
	WRAPPER_ACTIVATE(line, preadv64v2)
	WRAPPER_ACTIVATE(line, pwritev2)
	WRAPPER_ACTIVATE(line, pwritev64v2)
	WRAPPER_ACTIVATE(line, copy_file_range)
	WRAPPER_ACTIVATE(line, mmap)
	WRAPPER_ACTIVATE(line, mmap64)
	WRAPPER_ACTIVATE(line, munmap)
	WRAPPER_ACTIVATE(line, msync)
	WRAPPER_ACTIVATE(line, mremap)
	WRAPPER_ACTIVATE(line, madvise)
	WRAPPER_ACTIVATE(line, posix_madvise)
	WRAPPER_ACTIVATE(line, select)
	WRAPPER_ACTIVATE(line, sync)
	WRAPPER_ACTIVATE(line, syncfs)
	WRAPPER_ACTIVATE(line, fsync)
	WRAPPER_ACTIVATE(line, fdatasync)
	WRAPPER_ACTIVATE(line, dup)
	WRAPPER_ACTIVATE(line, dup2)
	WRAPPER_ACTIVATE(line, dup3)
	WRAPPER_ACTIVATE(line, fcntl)
	WRAPPER_ACTIVATE(line, socket)
	WRAPPER_ACTIVATE(line, accept)
	WRAPPER_ACTIVATE(line, accept4)
	WRAPPER_ACTIVATE(line, socketpair)
	WRAPPER_ACTIVATE(line, connect)
	WRAPPER_ACTIVATE(line, bind)
	WRAPPER_ACTIVATE(line, pipe)
	WRAPPER_ACTIVATE(line, pipe2)
	WRAPPER_ACTIVATE(line, memfd_create)
	WRAPPER_ACTIVATE(line, epoll_create)
	WRAPPER_ACTIVATE(line, epoll_create1)
	WRAPPER_ACTIVATE(line, mkstemp)
	WRAPPER_ACTIVATE(line, mkostemp)
	WRAPPER_ACTIVATE(line, mkstemps)
	WRAPPER_ACTIVATE(line, mkostemps)
	WRAPPER_ACTIVATE(line, eventfd)
	WRAPPER_ACTIVATE(line, inotify_init)
	WRAPPER_ACTIVATE(line, inotify_init1)
	WRAPPER_ACTIVATE(line, readdir)
	WRAPPER_ACTIVATE(line, dirfd)
	WRAPPER_ACTIVATE(line, sendmsg)
	WRAPPER_ACTIVATE(line, recvmsg)
	WRAPPER_ACTIVATE(line, sendmmsg)
	WRAPPER_ACTIVATE(line, recvmmsg)
	WRAPPER_ACTIVATE(line, fopen)
	WRAPPER_ACTIVATE(line, fopen64)
	WRAPPER_ACTIVATE(line, freopen)
	WRAPPER_ACTIVATE(line, freopen64)
	WRAPPER_ACTIVATE(line, fdopen)
	WRAPPER_ACTIVATE(line, fclose)
	WRAPPER_ACTIVATE(line, fcloseall)
	WRAPPER_ACTIVATE(line, flockfile)
	WRAPPER_ACTIVATE(line, ftrylockfile)
	WRAPPER_ACTIVATE(line, funlockfile)
	WRAPPER_ACTIVATE(line, fwide)
	WRAPPER_ACTIVATE(line, fputc)
	WRAPPER_ACTIVATE(line, fputwc)
	WRAPPER_ACTIVATE(line, fputc_unlocked)
	WRAPPER_ACTIVATE(line, fputwc_unlocked)
	WRAPPER_ACTIVATE(line, putc)
	WRAPPER_ACTIVATE(line, _IO_putc)
	WRAPPER_ACTIVATE(line, putwc)
	WRAPPER_ACTIVATE(line, putc_unlocked)
	WRAPPER_ACTIVATE(line, putwc_unlocked)
	WRAPPER_ACTIVATE(line, fputs)
	WRAPPER_ACTIVATE(line, fputws)
	WRAPPER_ACTIVATE(line, fputs_unlocked)
	WRAPPER_ACTIVATE(line, fputws_unlocked)
	WRAPPER_ACTIVATE(line, putw)
	WRAPPER_ACTIVATE(line, fgetc)
	WRAPPER_ACTIVATE(line, fgetwc)
	WRAPPER_ACTIVATE(line, fgetc_unlocked)
	WRAPPER_ACTIVATE(line, fgetwc_unlocked)
	WRAPPER_ACTIVATE(line, getc)
	WRAPPER_ACTIVATE(line, _IO_getc)
	WRAPPER_ACTIVATE(line, getwc)
	WRAPPER_ACTIVATE(line, getc_unlocked)
	WRAPPER_ACTIVATE(line, getwc_unlocked)
	WRAPPER_ACTIVATE(line, getw)
	WRAPPER_ACTIVATE(line, getline)
	WRAPPER_ACTIVATE(line, getdelim)
	WRAPPER_ACTIVATE(line, fgets)
	WRAPPER_ACTIVATE(line, fgetws)
	WRAPPER_ACTIVATE(line, fgets_unlocked)
	WRAPPER_ACTIVATE(line, fgetws_unlocked)
	WRAPPER_ACTIVATE(line, ungetc)
	WRAPPER_ACTIVATE(line, ungetwc)
	WRAPPER_ACTIVATE(line, fread)
	WRAPPER_ACTIVATE(line, fread_unlocked)
	WRAPPER_ACTIVATE(line, fwrite)
	WRAPPER_ACTIVATE(line, fwrite_unlocked)
	WRAPPER_ACTIVATE(line, fprintf)
	WRAPPER_ACTIVATE(line, fwprintf)
	WRAPPER_ACTIVATE(line, vfprintf)
	WRAPPER_ACTIVATE(line, vfwprintf)
	WRAPPER_ACTIVATE(line, fscanf)
	WRAPPER_ACTIVATE(line, fwscanf)
	WRAPPER_ACTIVATE(line, vfscanf)
	WRAPPER_ACTIVATE(line, vfwscanf)
	WRAPPER_ACTIVATE(line, feof)
	WRAPPER_ACTIVATE(line, feof_unlocked)
	WRAPPER_ACTIVATE(line, ferror)
	WRAPPER_ACTIVATE(line, ferror_unlocked)
	WRAPPER_ACTIVATE(line, clearerr)
	WRAPPER_ACTIVATE(line, clearerr_unlocked)
	WRAPPER_ACTIVATE(line, ftell)
	WRAPPER_ACTIVATE(line, ftello)
	WRAPPER_ACTIVATE(line, ftello64)
	WRAPPER_ACTIVATE(line, fseek)
	WRAPPER_ACTIVATE(line, fseeko)
	WRAPPER_ACTIVATE(line, fseeko64)
	WRAPPER_ACTIVATE(line, rewind)
	WRAPPER_ACTIVATE(line, fgetpos)
	WRAPPER_ACTIVATE(line, fgetpos64)
	WRAPPER_ACTIVATE(line, fsetpos)
	WRAPPER_ACTIVATE(line, fsetpos64)
	WRAPPER_ACTIVATE(line, fflush)
	WRAPPER_ACTIVATE(line, fflush_unlocked)
	WRAPPER_ACTIVATE(line, setvbuf)
	WRAPPER_ACTIVATE(line, setbuf)
	WRAPPER_ACTIVATE(line, setbuffer)
	WRAPPER_ACTIVATE(line, setlinebuf)
	WRAPPER_ACTIVATE(line, fileno)
	WRAPPER_ACTIVATE(line, tmpfile)
	WRAPPER_ACTIVATE(line, tmpfile64)
	WRAPPER_ACTIVATE(line, popen)
	WRAPPER_ACTIVATE(line, __freadable)
	WRAPPER_ACTIVATE(line, __fwritable)
	WRAPPER_ACTIVATE(line, __freading)
	WRAPPER_ACTIVATE(line, __fwriting)
	WRAPPER_ACTIVATE(line, __fsetlocking)
	WRAPPER_ACTIVATE(line, _flushlbf)
	WRAPPER_ACTIVATE(line, __fpurge)
	WRAPPER_ACTIVATE(line, __flbf)
	WRAPPER_ACTIVATE(line, __fbufsize)
	WRAPPER_ACTIVATE(line, __fpending)
	WRAPPER_ACTIVATE(line, fork)
	WRAPPER_ACTIVATE(line, vfork)
	WRAPPER_ACTIVATE(line, clone)
	else
	{
		ret = 0;
	}
