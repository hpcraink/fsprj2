...
//TODO: Hier Schalter definieren
char libio_open = WRAPPER_ACTIVE;
char libio_open64 = WRAPPER_ACTIVE;
char libio_openat = WRAPPER_ACTIVE;
char libio_creat = WRAPPER_ACTIVE;
char libio_creat64 = WRAPPER_ACTIVE;
char libio_close = WRAPPER_ACTIVE;
char libio_read = WRAPPER_ACTIVE;
char libio_pread = WRAPPER_ACTIVE;
char libio_pread64 = WRAPPER_ACTIVE;
char libio_write = WRAPPER_ACTIVE;
char libio_pwrite = WRAPPER_ACTIVE;
char libio_pwrite64 = WRAPPER_ACTIVE;
char libio_lseek = WRAPPER_ACTIVE;
char libio_lseek64 = WRAPPER_ACTIVE;
char libio_readv = WRAPPER_ACTIVE;
char libio_writev = WRAPPER_ACTIVE;
char libio_preadv = WRAPPER_ACTIVE;
char libio_preadv64 = WRAPPER_ACTIVE;
char libio_pwritev = WRAPPER_ACTIVE;
char libio_pwritev64 = WRAPPER_ACTIVE;
char libio_preadv2 = WRAPPER_ACTIVE;
char libio_preadv64v2 = WRAPPER_ACTIVE;
char libio_pwritev2 = WRAPPER_ACTIVE;
char libio_pwritev64v2 = WRAPPER_ACTIVE;
char libio_copy_file_range = WRAPPER_ACTIVE;
char libio_mmap = WRAPPER_ACTIVE;
char libio_mmap64 = WRAPPER_ACTIVE;
char libio_munmap = WRAPPER_ACTIVE;
char libio_msync = WRAPPER_ACTIVE;
char libio_mremap = WRAPPER_ACTIVE;
char libio_madvise = WRAPPER_ACTIVE;
char libio_posix_madvise = WRAPPER_ACTIVE;
char libio_select = WRAPPER_ACTIVE;
char libio_sync = WRAPPER_ACTIVE;
char libio_syncfs = WRAPPER_ACTIVE;
char libio_fsync = WRAPPER_ACTIVE;
char libio_fdatasync = WRAPPER_ACTIVE;
char libio_dup = WRAPPER_ACTIVE;
char libio_dup2 = WRAPPER_ACTIVE;
char libio_dup3 = WRAPPER_ACTIVE;
char libio_fcntl = WRAPPER_ACTIVE;
char libio_socket = WRAPPER_ACTIVE;
char libio_accept = WRAPPER_ACTIVE;
char libio_accept4 = WRAPPER_ACTIVE;
char libio_socketpair = WRAPPER_ACTIVE;
char libio_connect = WRAPPER_ACTIVE;
char libio_bind = WRAPPER_ACTIVE;
char libio_pipe = WRAPPER_ACTIVE;
char libio_pipe2 = WRAPPER_ACTIVE;
char libio_memfd_create = WRAPPER_ACTIVE;
char libio_epoll_create = WRAPPER_ACTIVE;
char libio_epoll_create1 = WRAPPER_ACTIVE;
char libio_mkstemp = WRAPPER_ACTIVE;
char libio_mkostemp = WRAPPER_ACTIVE;
char libio_mkstemps = WRAPPER_ACTIVE;
char libio_mkostemps = WRAPPER_ACTIVE;
char libio_eventfd = WRAPPER_ACTIVE;
char libio_inotify_init = WRAPPER_ACTIVE;
char libio_inotify_init1 = WRAPPER_ACTIVE;
char libio_readdir = WRAPPER_ACTIVE;
char libio_dirfd = WRAPPER_ACTIVE;
char libio_sendmsg = WRAPPER_ACTIVE;
char libio_recvmsg = WRAPPER_ACTIVE;
char libio_sendmmsg = WRAPPER_ACTIVE;
char libio_recvmmsg = WRAPPER_ACTIVE;
char libio_fopen = WRAPPER_ACTIVE;
char libio_fopen64 = WRAPPER_ACTIVE;
char libio_freopen = WRAPPER_ACTIVE;
char libio_freopen64 = WRAPPER_ACTIVE;
char libio_fdopen = WRAPPER_ACTIVE;
char libio_fclose = WRAPPER_ACTIVE;
char libio_fcloseall = WRAPPER_ACTIVE;
char libio_flockfile = WRAPPER_ACTIVE;
char libio_ftrylockfile = WRAPPER_ACTIVE;
char libio_funlockfile = WRAPPER_ACTIVE;
char libio_fwide = WRAPPER_ACTIVE;
char libio_fputc = WRAPPER_ACTIVE;
char libio_fputwc = WRAPPER_ACTIVE;
char libio_fputc_unlocked = WRAPPER_ACTIVE;
char libio_fputwc_unlocked = WRAPPER_ACTIVE;
char libio_putc = WRAPPER_ACTIVE;
char libio__IO_putc = WRAPPER_ACTIVE;
char libio_putwc = WRAPPER_ACTIVE;
char libio_putc_unlocked = WRAPPER_ACTIVE;
char libio_putwc_unlocked = WRAPPER_ACTIVE;
char libio_fputs = WRAPPER_ACTIVE;
char libio_fputws = WRAPPER_ACTIVE;
char libio_fputs_unlocked = WRAPPER_ACTIVE;
char libio_fputws_unlocked = WRAPPER_ACTIVE;
char libio_putw = WRAPPER_ACTIVE;
char libio_fgetc = WRAPPER_ACTIVE;
char libio_fgetwc = WRAPPER_ACTIVE;
char libio_fgetc_unlocked = WRAPPER_ACTIVE;
char libio_fgetwc_unlocked = WRAPPER_ACTIVE;
char libio_getc = WRAPPER_ACTIVE;
char libio__IO_getc = WRAPPER_ACTIVE;
char libio_getwc = WRAPPER_ACTIVE;
char libio_getc_unlocked = WRAPPER_ACTIVE;
char libio_getwc_unlocked = WRAPPER_ACTIVE;
char libio_getw = WRAPPER_ACTIVE;
char libio_getline = WRAPPER_ACTIVE;
char libio_getdelim = WRAPPER_ACTIVE;
char libio_fgets = WRAPPER_ACTIVE;
char libio_fgetws = WRAPPER_ACTIVE;
char libio_fgets_unlocked = WRAPPER_ACTIVE;
char libio_fgetws_unlocked = WRAPPER_ACTIVE;
char libio_ungetc = WRAPPER_ACTIVE;
char libio_ungetwc = WRAPPER_ACTIVE;
char libio_fread = WRAPPER_ACTIVE;
char libio_fread_unlocked = WRAPPER_ACTIVE;
char libio_fwrite = WRAPPER_ACTIVE;
char libio_fwrite_unlocked = WRAPPER_ACTIVE;
char libio_fprintf = WRAPPER_ACTIVE;
char libio_fwprintf = WRAPPER_ACTIVE;
char libio_vfprintf = WRAPPER_ACTIVE;
char libio_vfwprintf = WRAPPER_ACTIVE;
char libio_fscanf = WRAPPER_ACTIVE;
char libio_fwscanf = WRAPPER_ACTIVE;
char libio_vfscanf = WRAPPER_ACTIVE;
char libio_vfwscanf = WRAPPER_ACTIVE;
char libio_feof = WRAPPER_ACTIVE;
char libio_feof_unlocked = WRAPPER_ACTIVE;
char libio_ferror = WRAPPER_ACTIVE;
char libio_ferror_unlocked = WRAPPER_ACTIVE;
char libio_clearerr = WRAPPER_ACTIVE;
char libio_clearerr_unlocked = WRAPPER_ACTIVE;
char libio_ftell = WRAPPER_ACTIVE;
char libio_ftello = WRAPPER_ACTIVE;
char libio_ftello64 = WRAPPER_ACTIVE;
char libio_fseek = WRAPPER_ACTIVE;
char libio_fseeko = WRAPPER_ACTIVE;
char libio_fseeko64 = WRAPPER_ACTIVE;
char libio_rewind = WRAPPER_ACTIVE;
char libio_fgetpos = WRAPPER_ACTIVE;
char libio_fgetpos64 = WRAPPER_ACTIVE;
char libio_fsetpos = WRAPPER_ACTIVE;
char libio_fsetpos64 = WRAPPER_ACTIVE;
char libio_fflush = WRAPPER_ACTIVE;
char libio_fflush_unlocked = WRAPPER_ACTIVE;
char libio_setvbuf = WRAPPER_ACTIVE;
char libio_setbuf = WRAPPER_ACTIVE;
char libio_setbuffer = WRAPPER_ACTIVE;
char libio_setlinebuf = WRAPPER_ACTIVE;
char libio_fileno = WRAPPER_ACTIVE;
char libio_tmpfile = WRAPPER_ACTIVE;
char libio_tmpfile64 = WRAPPER_ACTIVE;
char libio_popen = WRAPPER_ACTIVE;
char libio___freadable = WRAPPER_ACTIVE;
char libio___fwritable = WRAPPER_ACTIVE;
char libio___freading = WRAPPER_ACTIVE;
char libio___fwriting = WRAPPER_ACTIVE;
char libio___fsetlocking = WRAPPER_ACTIVE;
char libio__flushlbf = WRAPPER_ACTIVE;
char libio___fpurge = WRAPPER_ACTIVE;
char libio___flbf = WRAPPER_ACTIVE;
char libio___fbufsize = WRAPPER_ACTIVE;
char libio___fpending = WRAPPER_ACTIVE;
char libio_fork = WRAPPER_ACTIVE;
char libio_vfork = WRAPPER_ACTIVE;
char libio_clone = WRAPPER_ACTIVE;
...
char toggle_posix_wrapper(char *line, char toggle)
{
	...
	WRAPPER_ACTIVATE(line, open, toggle)
	WRAPPER_ACTIVATE(line, open64, toggle)
	WRAPPER_ACTIVATE(line, openat, toggle)
	WRAPPER_ACTIVATE(line, creat, toggle)
	WRAPPER_ACTIVATE(line, creat64, toggle)
	WRAPPER_ACTIVATE(line, close, toggle)
	WRAPPER_ACTIVATE(line, read, toggle)
	WRAPPER_ACTIVATE(line, pread, toggle)
	WRAPPER_ACTIVATE(line, pread64, toggle)
	WRAPPER_ACTIVATE(line, write, toggle)
	WRAPPER_ACTIVATE(line, pwrite, toggle)
	WRAPPER_ACTIVATE(line, pwrite64, toggle)
	WRAPPER_ACTIVATE(line, lseek, toggle)
	WRAPPER_ACTIVATE(line, lseek64, toggle)
	WRAPPER_ACTIVATE(line, readv, toggle)
	WRAPPER_ACTIVATE(line, writev, toggle)
	WRAPPER_ACTIVATE(line, preadv, toggle)
	WRAPPER_ACTIVATE(line, preadv64, toggle)
	WRAPPER_ACTIVATE(line, pwritev, toggle)
	WRAPPER_ACTIVATE(line, pwritev64, toggle)
	WRAPPER_ACTIVATE(line, preadv2, toggle)
	WRAPPER_ACTIVATE(line, preadv64v2, toggle)
	WRAPPER_ACTIVATE(line, pwritev2, toggle)
	WRAPPER_ACTIVATE(line, pwritev64v2, toggle)
	WRAPPER_ACTIVATE(line, copy_file_range, toggle)
	WRAPPER_ACTIVATE(line, mmap, toggle)
	WRAPPER_ACTIVATE(line, mmap64, toggle)
	WRAPPER_ACTIVATE(line, munmap, toggle)
	WRAPPER_ACTIVATE(line, msync, toggle)
	WRAPPER_ACTIVATE(line, mremap, toggle)
	WRAPPER_ACTIVATE(line, madvise, toggle)
	WRAPPER_ACTIVATE(line, posix_madvise, toggle)
	WRAPPER_ACTIVATE(line, select, toggle)
	WRAPPER_ACTIVATE(line, sync, toggle)
	WRAPPER_ACTIVATE(line, syncfs, toggle)
	WRAPPER_ACTIVATE(line, fsync, toggle)
	WRAPPER_ACTIVATE(line, fdatasync, toggle)
	WRAPPER_ACTIVATE(line, dup, toggle)
	WRAPPER_ACTIVATE(line, dup2, toggle)
	WRAPPER_ACTIVATE(line, dup3, toggle)
	WRAPPER_ACTIVATE(line, fcntl, toggle)
	WRAPPER_ACTIVATE(line, socket, toggle)
	WRAPPER_ACTIVATE(line, accept, toggle)
	WRAPPER_ACTIVATE(line, accept4, toggle)
	WRAPPER_ACTIVATE(line, socketpair, toggle)
	WRAPPER_ACTIVATE(line, connect, toggle)
	WRAPPER_ACTIVATE(line, bind, toggle)
	WRAPPER_ACTIVATE(line, pipe, toggle)
	WRAPPER_ACTIVATE(line, pipe2, toggle)
	WRAPPER_ACTIVATE(line, memfd_create, toggle)
	WRAPPER_ACTIVATE(line, epoll_create, toggle)
	WRAPPER_ACTIVATE(line, epoll_create1, toggle)
	WRAPPER_ACTIVATE(line, mkstemp, toggle)
	WRAPPER_ACTIVATE(line, mkostemp, toggle)
	WRAPPER_ACTIVATE(line, mkstemps, toggle)
	WRAPPER_ACTIVATE(line, mkostemps, toggle)
	WRAPPER_ACTIVATE(line, eventfd, toggle)
	WRAPPER_ACTIVATE(line, inotify_init, toggle)
	WRAPPER_ACTIVATE(line, inotify_init1, toggle)
	WRAPPER_ACTIVATE(line, readdir, toggle)
	WRAPPER_ACTIVATE(line, dirfd, toggle)
	WRAPPER_ACTIVATE(line, sendmsg, toggle)
	WRAPPER_ACTIVATE(line, recvmsg, toggle)
	WRAPPER_ACTIVATE(line, sendmmsg, toggle)
	WRAPPER_ACTIVATE(line, recvmmsg, toggle)
	WRAPPER_ACTIVATE(line, fopen, toggle)
	WRAPPER_ACTIVATE(line, fopen64, toggle)
	WRAPPER_ACTIVATE(line, freopen, toggle)
	WRAPPER_ACTIVATE(line, freopen64, toggle)
	WRAPPER_ACTIVATE(line, fdopen, toggle)
	WRAPPER_ACTIVATE(line, fclose, toggle)
	WRAPPER_ACTIVATE(line, fcloseall, toggle)
	WRAPPER_ACTIVATE(line, flockfile, toggle)
	WRAPPER_ACTIVATE(line, ftrylockfile, toggle)
	WRAPPER_ACTIVATE(line, funlockfile, toggle)
	WRAPPER_ACTIVATE(line, fwide, toggle)
	WRAPPER_ACTIVATE(line, fputc, toggle)
	WRAPPER_ACTIVATE(line, fputwc, toggle)
	WRAPPER_ACTIVATE(line, fputc_unlocked, toggle)
	WRAPPER_ACTIVATE(line, fputwc_unlocked, toggle)
	WRAPPER_ACTIVATE(line, putc, toggle)
	WRAPPER_ACTIVATE(line, _IO_putc, toggle)
	WRAPPER_ACTIVATE(line, putwc, toggle)
	WRAPPER_ACTIVATE(line, putc_unlocked, toggle)
	WRAPPER_ACTIVATE(line, putwc_unlocked, toggle)
	WRAPPER_ACTIVATE(line, fputs, toggle)
	WRAPPER_ACTIVATE(line, fputws, toggle)
	WRAPPER_ACTIVATE(line, fputs_unlocked, toggle)
	WRAPPER_ACTIVATE(line, fputws_unlocked, toggle)
	WRAPPER_ACTIVATE(line, putw, toggle)
	WRAPPER_ACTIVATE(line, fgetc, toggle)
	WRAPPER_ACTIVATE(line, fgetwc, toggle)
	WRAPPER_ACTIVATE(line, fgetc_unlocked, toggle)
	WRAPPER_ACTIVATE(line, fgetwc_unlocked, toggle)
	WRAPPER_ACTIVATE(line, getc, toggle)
	WRAPPER_ACTIVATE(line, _IO_getc, toggle)
	WRAPPER_ACTIVATE(line, getwc, toggle)
	WRAPPER_ACTIVATE(line, getc_unlocked, toggle)
	WRAPPER_ACTIVATE(line, getwc_unlocked, toggle)
	WRAPPER_ACTIVATE(line, getw, toggle)
	WRAPPER_ACTIVATE(line, getline, toggle)
	WRAPPER_ACTIVATE(line, getdelim, toggle)
	WRAPPER_ACTIVATE(line, fgets, toggle)
	WRAPPER_ACTIVATE(line, fgetws, toggle)
	WRAPPER_ACTIVATE(line, fgets_unlocked, toggle)
	WRAPPER_ACTIVATE(line, fgetws_unlocked, toggle)
	WRAPPER_ACTIVATE(line, ungetc, toggle)
	WRAPPER_ACTIVATE(line, ungetwc, toggle)
	WRAPPER_ACTIVATE(line, fread, toggle)
	WRAPPER_ACTIVATE(line, fread_unlocked, toggle)
	WRAPPER_ACTIVATE(line, fwrite, toggle)
	WRAPPER_ACTIVATE(line, fwrite_unlocked, toggle)
	WRAPPER_ACTIVATE(line, fprintf, toggle)
	WRAPPER_ACTIVATE(line, fwprintf, toggle)
	WRAPPER_ACTIVATE(line, vfprintf, toggle)
	WRAPPER_ACTIVATE(line, vfwprintf, toggle)
	WRAPPER_ACTIVATE(line, fscanf, toggle)
	WRAPPER_ACTIVATE(line, fwscanf, toggle)
	WRAPPER_ACTIVATE(line, vfscanf, toggle)
	WRAPPER_ACTIVATE(line, vfwscanf, toggle)
	WRAPPER_ACTIVATE(line, feof, toggle)
	WRAPPER_ACTIVATE(line, feof_unlocked, toggle)
	WRAPPER_ACTIVATE(line, ferror, toggle)
	WRAPPER_ACTIVATE(line, ferror_unlocked, toggle)
	WRAPPER_ACTIVATE(line, clearerr, toggle)
	WRAPPER_ACTIVATE(line, clearerr_unlocked, toggle)
	WRAPPER_ACTIVATE(line, ftell, toggle)
	WRAPPER_ACTIVATE(line, ftello, toggle)
	WRAPPER_ACTIVATE(line, ftello64, toggle)
	WRAPPER_ACTIVATE(line, fseek, toggle)
	WRAPPER_ACTIVATE(line, fseeko, toggle)
	WRAPPER_ACTIVATE(line, fseeko64, toggle)
	WRAPPER_ACTIVATE(line, rewind, toggle)
	WRAPPER_ACTIVATE(line, fgetpos, toggle)
	WRAPPER_ACTIVATE(line, fgetpos64, toggle)
	WRAPPER_ACTIVATE(line, fsetpos, toggle)
	WRAPPER_ACTIVATE(line, fsetpos64, toggle)
	WRAPPER_ACTIVATE(line, fflush, toggle)
	WRAPPER_ACTIVATE(line, fflush_unlocked, toggle)
	WRAPPER_ACTIVATE(line, setvbuf, toggle)
	WRAPPER_ACTIVATE(line, setbuf, toggle)
	WRAPPER_ACTIVATE(line, setbuffer, toggle)
	WRAPPER_ACTIVATE(line, setlinebuf, toggle)
	WRAPPER_ACTIVATE(line, fileno, toggle)
	WRAPPER_ACTIVATE(line, tmpfile, toggle)
	WRAPPER_ACTIVATE(line, tmpfile64, toggle)
	WRAPPER_ACTIVATE(line, popen, toggle)
	WRAPPER_ACTIVATE(line, __freadable, toggle)
	WRAPPER_ACTIVATE(line, __fwritable, toggle)
	WRAPPER_ACTIVATE(line, __freading, toggle)
	WRAPPER_ACTIVATE(line, __fwriting, toggle)
	WRAPPER_ACTIVATE(line, __fsetlocking, toggle)
	WRAPPER_ACTIVATE(line, _flushlbf, toggle)
	WRAPPER_ACTIVATE(line, __fpurge, toggle)
	WRAPPER_ACTIVATE(line, __flbf, toggle)
	WRAPPER_ACTIVATE(line, __fbufsize, toggle)
	WRAPPER_ACTIVATE(line, __fpending, toggle)
	WRAPPER_ACTIVATE(line, fork, toggle)
	WRAPPER_ACTIVATE(line, vfork, toggle)
	WRAPPER_ACTIVATE(line, clone, toggle)
	else
	{
		ret = 0;
	}
