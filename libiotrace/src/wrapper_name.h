#define WRAPPER_NAME_TO_LIBIOTRACE_STRUCT 0
...
#if WRAPPER_NAME_TO_SOURCE == WRAPPER_NAME_TO_LIBIOTRACE_STRUCT
#  define WRAPPER_NAME(function_name) LIBIOTRACE_STRUCT_CHAR(function_name)
