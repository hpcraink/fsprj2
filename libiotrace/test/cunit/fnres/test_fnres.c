...
void test_posix_fildes_open_read_close(void) {
    ...
    struct basic af1_open = {
            .function_name = "open",
            .return_state = ok,
            .__file_type = &tmp_af1_file_type, .__void_p_enum_file_type = __void_p_enum_file_type_file_descriptor,
            .__function_data = &tmp_af1_function_data, .__void_p_enum_function_data = __void_p_enum_function_data_open_function
    };
...
void test_posix_pipe2_lseek(void) {
    ...
    struct basic af1_pipe2 = {
            .function_name = "pipe2",
            .return_state = ok,
            .__function_data = &tmp_af1_function_data, .__void_p_enum_function_data = __void_p_enum_function_data_file_pair
    };
    ...
    struct basic bf1_lseek = {
            .function_name = "lseek",
            .return_state = ok,
            .__file_type = &tmp_bf1_file_type, .__void_p_enum_file_type = __void_p_enum_file_type_file_descriptor
    };
    ...
    struct basic bf2_pread = {
            .function_name = "pread",
            .return_state = ok,
            .__file_type = &tmp_bf2_file_type, .__void_p_enum_file_type = __void_p_enum_file_type_file_descriptor
    };
    /* -- Create test data -- */
...
void test_posix_stream_fildes_fileno_fwrite(void) {
    ...
    struct basic af2_fileno = {
            ...
            .return_state = ok,
            .__file_type = &tmp_af1_file_type, .__void_p_enum_file_type = __void_p_enum_file_type_file_stream,
            .__function_data = &tmp_af2_function_data, .__void_p_enum_function_data = __void_p_enum_function_data_fileno_function
    };
...
void test_posix_creat_mmap_msync_mremap_munmap(void) {
    ...
    struct basic af2_mmap = {
            ...
            .return_state = ok,
            .__file_type = &tmp_af1_file_type, .__void_p_enum_file_type = __void_p_enum_file_type_file_descriptor,
            .__function_data = &tmp_af2_function_data, .__void_p_enum_function_data = __void_p_enum_function_data_memory_map_function
    };
    ...
    struct basic bf2_mremap = {
            ...
            .return_state = ok,
            .__file_type = &tmp_bf1_file_type, .__void_p_enum_file_type = __void_p_enum_file_type_file_memory,
            .__function_data = &tmp_bf2_function_data, .__void_p_enum_function_data = __void_p_enum_function_data_memory_remap_function
    };
    ...
    bf4_msync_new.__file_type = &tmp_bf4_file_type;

    struct basic cf1_munmap = {
            .function_name = "munmap",
            .return_state = ok,
            .__file_type = &tmp_bf4_file_type, .__void_p_enum_file_type = __void_p_enum_file_type_file_memory,
    };
    /* -- Create test data -- */
...
void test_mpi_open_immediate_close(void) {
    ...
    struct basic af1_MPI_File_open = {
            ...
            .__function_data = &tmp_af1_function_data, .__void_p_enum_function_data = __void_p_enum_function_data_mpi_open_function
    };
    ...
    struct basic bf2_MPI_File_iwrite = {
            ...
            .return_state = ok,
            .__file_type = &tmp_af1_file_type, .__void_p_enum_file_type = __void_p_enum_file_type_file_mpi,
            .__function_data = &tmp_bf2_function_data, .__void_p_enum_function_data = __void_p_enum_function_data_mpi_immediate
    };
    ...
    struct basic bf3_MPI_Wait = {
            ...
            .return_state = ok,
            .__file_type = &tmp_bf3_file_type, .__void_p_enum_file_type = __void_p_enum_file_type_request_mpi
    };

    struct basic cf1_MPI_Request_free = {
            .function_name = "MPI_Request_free",
            .return_state = ok,
            .__file_type = &tmp_bf2_function_data, .__void_p_enum_file_type = __void_p_enum_file_type_request_mpi
    };
...
void test_posix_freopen_same_file(void) {
    ...
    struct basic af2_freopen = {
            ...
            .return_state = ok,
            .__file_type = &tmp_af1_file_type, .__void_p_enum_file_type = __void_p_enum_file_type_file_descriptor,
            .__function_data = &tmp_af2_function_data, .__void_p_enum_function_data = __void_p_enum_function_data_open_function
    };
    /* -- Create test data -- */
